...
import com.dollop.hbh_service_engineer.basic.UtilityTools.SavedData.getCountryKey
...
/**            val p = Pattern.compile(
            ...
            if(editText.text.length > 5)
            {
               true
                ...
                EditTextPointer = editText
                errorMessage = context.getString(R.string.the_password_must_contain_at_least_6_characters)
                false
            }
        }
    }
